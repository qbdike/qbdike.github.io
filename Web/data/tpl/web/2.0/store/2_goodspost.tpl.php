		...
		<?php  } else { ?>
			...
			<div class="form-group">
				<label class="control-label col-sm-2">
					<?php  if(empty($all_type_info[$goods_info['type']])) { ?>
					商品名称
					<?php  } else { ?>
					<?php  echo $all_type_info[$goods_info['type']]['title'];?>
					<?php  } ?>
				</label>
				<div class="col-sm-3">
			...
			<?php  } ?>
			<?php  if(in_array($type, array(STORE_TYPE_MODULE, STORE_TYPE_WXAPP_MODULE, STORE_TYPE_WEBAPP_MODULE, STORE_TYPE_PHONEAPP_MODULE, STORE_TYPE_XZAPP_MODULE, STORE_TYPE_ALIAPP_MODULE, STORE_TYPE_BAIDUAPP_MODULE, STORE_TYPE_TOUTIAOAPP_MODULE))) { ?>
			<div class="form-group">
