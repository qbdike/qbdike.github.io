...
<table class="table table-bordered">
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        <a href="<?php  echo $this->createWebUrl('editmember');?>&openid=<?php  echo $row['openid'];?>" class="btn btn-success btn-xs"><i class="fa fa-edit"></i>&nbsp;编辑</a>
        <a class="btn btn-danger btn-xs delete" href="#" onclick="window.confirm('确定删除吗？')?this.href='<?php  echo $this->createWebUrl('member');?>&method=delete&openid=<?php  echo $row['openid'];?>':this.href='javascript:void()';"><i class="fa fa-trash"></i>&nbsp;删除</a>
</td>
    </tr>
    <?php  } } ?>
