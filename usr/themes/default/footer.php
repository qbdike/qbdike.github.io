...
<footer id="colophon" class="site-footer" role="contentinfo">
	...
	<div id="footer" class="site-info">Copyright © <?php echo date("Y");?> by <a href="<?php $this->options ->siteUrl(); ?>" target="_blank" rel="nofollow"><?php $this->options->title() ?></a> . All rights reserved.<span class="sep"> | </span><a href="#" target="_blank" rel="nofollow"><?php $this->options->ICP();?></a>.
	</div>
</footer>
<div id="mo-nav">
	<div class="m-avatar">
