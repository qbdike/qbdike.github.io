	...
	<h1 class="fes-title">日常</h1>
		...
		<?php
			...
			if(sizeof($featureCid)==3){
				...
				echo '
				<li class="feature-1"><a href="https://yqindik.xyz/Web/theme.html"><div class="feature-title"><span class="foverlay">生活</span></div><img src="'.theurl.'/images/feature/feature1.jpg"></a></li>
				<li class="feature-2"><a href="https://yqindik.xyz/Web/user.html"><div class="feature-title"><span class="foverlay">方法</span></div><img src="'.theurl.'/images/feature/feature2.jpg"></a></li>
				<li class="feature-3"><a href="https://yqindik.xyz/archives.html"><div class="feature-title"><span class="foverlay">文章</span></div><img src="'.theurl.'/images/feature/feature3.jpg"></a></li>';
			}
		?>
		</div>
</div>
