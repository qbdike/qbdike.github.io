	...
	<header id="we-header">
		<div class="we-branding">
			<div class="wesite-title">
				<a href="<?php $this->options ->siteUrl(index.php); ?>" ><img src="<?php echo theurl; ?>images/akina.png"></a>
			</div>
...
<div class="we-footer">
	<div class="we-info">Copyright © 2019 by <a href="<?php $this->options ->siteUrl(); ?>" target="_blank" rel="nofollow"><?php $this->options->title() ?></a> . All rights reserved.	<span class="sep"> <span class="we-footertext"> | <a href="https://zhebk.cn/">Akina for Typecho</a> | </span><a href="http://www.beian.miit.gov.cn/" target="_blank" rel="nofollow"><?php $this->options->ICP();?></a>.
		</span>
	</div>
</div>
